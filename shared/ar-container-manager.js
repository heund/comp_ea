...
class ARContainerManager {
    ...
    activateModule(markerId) {
        ...
        console.log(`Activating module for marker: ${markerId}`);
        ...
        if (!moduleInfo.instance) {
            try {
                ...
                console.error(`Error creating module instance for marker ${markerId}:`, error);
                return;
            }
        }
        ...
        try {
            ...
            console.error(`Error activating module for marker ${markerId}:`, error);
        }
    }
    ...
    deactivateCurrentModule() {
        ...
        console.log(`Deactivating current module: ${this.activeMarkerId}`);
